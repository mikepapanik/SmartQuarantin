    ...
    public partial class Pizza : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if (radioButton1.Checked == true)
            {
                ...
                {
                    ListViewItem item = new ListViewItem("Μικρή Πίτσα Κανονική");
                    item.SubItems.Add("1");
                ...
                {
                    ListViewItem item = new ListViewItem("Μικρή Πίτσα 4 Τυριά");
                    item.SubItems.Add("1");
                    item.SubItems.Add("4,00");
                    listView1.Items.Add(item);
                ...
                {
                    ListViewItem item = new ListViewItem("Μικρή Πίτσα με Σάλτσα Κοκτέιλ");
                    item.SubItems.Add("1");
                    item.SubItems.Add("4,00");
                    listView1.Items.Add(item);
            ...
            else if (radioButton2.Checked == true)
            {
                if (radioButton5.Checked == true)
                {
                    ListViewItem item = new ListViewItem("Μεσαία Πίτσα Κανονική");
                    item.SubItems.Add("1");
                ...
                {
                    ListViewItem item = new ListViewItem("Μεσαία Πίτσα 4 Τυριά");
                    item.SubItems.Add("1");
                    item.SubItems.Add("6,00");
                    listView1.Items.Add(item);
                ...
                {
                    ListViewItem item = new ListViewItem("Μεσαία Πίτσα με Σάλτσα Κοκτέιλ");
                    item.SubItems.Add("1");
                    item.SubItems.Add("6,00");
                    listView1.Items.Add(item);
            ...
            else if (radioButton3.Checked == true)
            {
                if (radioButton5.Checked == true)
                {
                    ListViewItem item = new ListViewItem("Μεγάλη Πίτσα Κανονική");
                    item.SubItems.Add("1");
                ...
                {
                    ListViewItem item = new ListViewItem("Μεγάλη Πίτσα με 4 Τυριά");
                    item.SubItems.Add("1");
                    item.SubItems.Add("8,00");
                    listView1.Items.Add(item);
                ...
                {
                    ListViewItem item = new ListViewItem("Μεγάλη Πίτσα με Σάλτσα Κοκτέιλ");
                    item.SubItems.Add("1");
                    item.SubItems.Add("8,00");
                    listView1.Items.Add(item);
            ...
            else if (radioButton4.Checked == true)
            {
                if (radioButton5.Checked == true)
                {
                    ListViewItem item = new ListViewItem("Πολύ Μεγάλη Πίτσα Κανονική");
                    item.SubItems.Add("1");
                ...
                {
                    ListViewItem item = new ListViewItem("Πολύ Μεγάλη Πίτσα με 4 Τυριά");
                    item.SubItems.Add("1");
                    item.SubItems.Add("10,00");
                    listView1.Items.Add(item);
                ...
                {
                    ListViewItem item = new ListViewItem("Πολύ Μεγάλη Πίτσα με Σάλτσα Κοκτέιλ");
                    item.SubItems.Add("1");
                    item.SubItems.Add("10,00");
                    listView1.Items.Add(item);
                }
            ...
            {
                ListViewItem item = new ListViewItem("  Πεπερόνι");
                item.SubItems.Add("");
            ...
            {
                ListViewItem item = new ListViewItem("  Έχτρα Τυριά");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Μανιτάρια");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Ζαμπόν");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Μπέικον");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Κοτόπουλο");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Πιπεριά");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Ελιές");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Μοτσαρέλα");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Λουκάνικο");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Σαλάμι");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Προσούτο");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("  Κρεμμύδι");
                item.SubItems.Add("");
                item.SubItems.Add("1,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("Μακαρόνια με Γαρίδες ");
                item.SubItems.Add("1");
                item.SubItems.Add("8,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("Σαλάτα του Σεφ ");
                item.SubItems.Add("1");
                item.SubItems.Add("6,00");
                listView1.Items.Add(item);
            ...
            {
                ListViewItem item = new ListViewItem("Σαλάτα του Καίσαρα ");
                item.SubItems.Add("1");
                item.SubItems.Add("6,00");
                listView1.Items.Add(item);
