...
namespace SmartQuarantin
{
    partial class Map2
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Μπορείτε να μετακινηθείτε είτε με το λεωφορείο είτε με το αυτοκίνητο.";
            // 
            // Map2
            // 
            ...
            this.Name = "Map2";
            this.Text = "Map2";
            this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.Map2_FormClosing);
